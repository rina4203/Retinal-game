...
FONT_FILE = "font.otf"         #< Custom font path
...
def draw_text(surf, text, font, x, y, color, align="center"):
    ...
    @code
    draw_text(screen, "Hello", font, 100, 100, (255,255,255), "center")
    @endcode
    """
...
class ObjectManager(Generic[T]):
    ...
    @code
    star_manager = ObjectManager[Star]()
    star_manager.add(Star(...))
    @endcode
    """
